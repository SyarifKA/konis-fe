            ...
            <div className="min-w-3/4 px-16 flex flex-col justify-center gap-4">
                ...
                <form action="" className="flex flex-col gap-4 w-1/2">
                    ...
                    <div className="w-full mt-4">
                        <button className="bg-primary w-full py-4 font-medium text-xl rounded-lg cursor-pointer">Login</button>
                    </div>
                    <div className="flex gap-1 justify-center">
                        <span>Not Have An Account?</span>
                        <button className="text-primary cursor-pointer">Register</button>
                    </div>
