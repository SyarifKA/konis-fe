...
export default function DetailProduct({ params }) {
  ...
  const dataMenu = [
    { id: 1, slug: "hazelnut-latte", image: "/img/menu1.jpg", title: "Hazelnut Latte", desc: "You can explore the menu that we provide with fun and have their own taste and make your day better.", priceBefore: 40000, price: 20000, flashSale: true },
    { id: 2, slug: "mocha-latte", image: "/img/menu2.png", title: "Mocha Latte", desc: "A mix of chocolate and espresso to brighten your mood.", priceBefore: 42000, price: 21000, flashSale: true },
    { id: 3, slug: "caramel-macchiato", image: "/img/menu3.png", title: "Caramel Macchiato", desc: "Espresso with caramel flavor that gives a sweet touch to your day.", priceBefore: 35000, price: 14000, flashSale: true },
    { id: 4, slug: "vanilla-latte", image: "/img/menu4.png", title: "Vanilla Latte", desc: "Smooth and creamy latte with a hint of vanilla aroma.", priceBefore: 25000, price: 19000, flashSale: true },
    { id: 5, slug: "americano", image: "/img/menu4.png", title: "Americano", desc: "Classic black coffee for a strong and bold flavor.", priceBefore: 19000, price: 8000, flashSale: true },
    { id: 6, slug: "espresso", image: "/img/menu3.png", title: "Espresso", desc: "Pure espresso shot to keep you energized.", priceBefore: 18500, price: 14000, flashSale: true },
    { id: 7, slug: "matcha-latte", image: "/img/menu2.png", title: "Matcha Latte", desc: "Green tea blend with milk for a relaxing taste.", priceBefore: 30000, price: 23000, flashSale: true },
    { id: 8, slug: "cold-brew", image: "/img/menu1.jpg", title: "Cold Brew", desc: "Smooth and refreshing coffee brewed cold for hours.", priceBefore: 26000, price: 24000, flashSale: true },
  ]
  ...
  return (
    <div className="mt-30 px-4 md:px-30 flex flex-col gap-12">
      {/* --- BAGIAN DETAIL PRODUK --- */}
      <section className="flex flex-col md:flex-row gap-8">
        {/* Gambar Produk */}
        <div className="flex flex-col gap-4 w-full md:max-w-[500px]">
          {/* Gambar utama */}
          <div className="relative w-full aspect-[4/3] md:h-[400px] md:aspect-auto rounded-xl overflow-hidden">
            <Image
              src={product.image}
              alt="Detail Produk"
              fill
          ...
          <div className="flex gap-3 w-full">
            {[Dp2, Dp3, Dp4].map((img, i) => (
              <div key={i} className="relative w-1/3 aspect-square md:h-[120px] md:aspect-auto rounded-xl overflow-hidden">
                <Image
                  src={img}
                  alt="Detail Produk"
                  fill
        ...
        <div className="flex flex-col gap-4 w-full">
          <FlashSale />
          <h1 className="text-3xl md:text-5xl font-medium text-left">{product.title}</h1>
          ...
          <form className="flex flex-col gap-4 w-full">
                ...
                {variants.map((variant) => (
                  ...
                  >
                    <input
                      ...
                      value={variant}
                      checked={selectedVariant === variant}
                      onChange={() => setSelectedVariant(selectedVariant === variant ? '' : variant)}
                      className="hidden"
                    />
                    {variant}
                  </label>
            ...
            <div className="flex flex-col md:flex-row gap-4 md:gap-6 w-full justify-center md:justify-start">
              <button type="button" className="bg-primary text-black w-full md:w-1/4 py-2 rounded-lg cursor-pointer">Buy</button>
              <button type="button" className="text-primary border border-primary w-full md:w-1/4 py-2 rounded-lg cursor-pointer">Add to Cart</button>
            </div>
          </form>
        </div>
      </section>
