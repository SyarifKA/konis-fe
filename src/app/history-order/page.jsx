...
//             <h1 className="text-5xl font-semibold">History Order</h1>
//             <section className="flex gap-6 w-full">
//                 <div className="flex flex-col gap-4 w-1/2">
//                     <div className="flex justify-between">
//                         <div className="flex items-center bg-gray-200 px-4 py-2">
//                             <button className="px-4 py-2 focus:bg-white">On Progress</button>
//                             <button className="px-4 py-2 focus:bg-white">Sending Goods</button>
//                             <button className="px-4 py-2 focus:bg-white">Finish Order</button>
//                         </div>
//                         <div className="flex items-center bg-gray-200 px-4 py-2">
//                             <input type="date" />
//                         </div>
...
//                     </div>
//                 </div>
//                 <div className="w-1/2 p-6 border border-gray-200 flex flex-col gap-6 text-black h-fit">
//                     <button className="bg-black cursor-pointer text-primary text-2xl w-fit p-4 rounded-xl">
//                         <BsChatLeftText/>
//                     </button>
//                     <h1 className="text-xl font-semibold ">Send Us Message</h1>
//                     <p className="text-gray-600">if your unable to find answer or find your product quickly, please describe your problem and tell us. we will give you solution.</p>
//                     <button className="bg-primary py-2 rounded-lg cursor-pointer">Send Message</button>
//                 </div>
//             </section>
//         </div>
//     )
